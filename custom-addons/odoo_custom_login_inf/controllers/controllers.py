...
class Home(http.Controller):
    ...
    def web_login(self, redirect=None, **kw):
        ...
        values["reset_password_enabled"] = param_obj.get_param(
            "auth_signup.reset_password"
        )
        values["signup_enabled"] = (
            param_obj.get_param("auth_signup.invitation_scope") == "b2c"
        )
        values["disable_footer"] = param_obj.get_param("disable_footer")
        
        return request.render("odoo_custom_login_inf.right_login_template", values)
